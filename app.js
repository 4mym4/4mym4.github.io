...
const showAllPresentNotesSelector=document.querySelector('#show-all-present-notes');
...
const app = {
    ...
    setupFretboard(){
        ...
        allNotes=document.querySelectorAll('.note-fret'); //https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8ccy7lXCivRlHgy8llZp5PmescdQduREL3w&usqp=CAU
    },
    ...
    setupEventListeners(){
        ...
        showAllPresentNotesSelector.addEventListener('change',()=>{
